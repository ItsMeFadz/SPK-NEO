...
<head>
    ...
    <title>Referensi Jurnal SADARI | SI-NEO</title>
...
<body class="bg-pink-50 text-gray-700 antialiased min-h-screen flex flex-col">
    ...
    <header class="fixed w-full z-50 top-0 glass-header shadow-sm">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-xl font-black text-gray-800">Referensi Jurnal SADARI</h1>
                    <p class="text-xs font-bold text-pink-500 uppercase tracking-widest">SI-NEO Edukasi</p>
                </div>
            </div>
            
            <a href="assets/landing/dokumen/jurnal sadari.pdf" download class="hidden sm:flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-pink-500 to-purple-600 text-white text-sm font-bold rounded-xl shadow-lg hover:shadow-pink-500/30 transition-all active:scale-95">
    ...
    <main class="flex-grow container mx-auto px-4 md:px-6 pt-28 pb-10 flex flex-col">
        ...
        <div class="sm:hidden mb-4 p-4 bg-white rounded-2xl shadow-sm border border-pink-100 text-center">
            ...
            <a href="assets/landing/dokumen/jurnal sadari.pdf" download class="inline-flex items-center gap-2 px-6 py-2 bg-pink-600 text-white text-sm font-bold rounded-xl shadow-md">
        ...
        <div class="w-full flex-grow bg-white rounded-3xl shadow-2xl border-4 border-white overflow-hidden relative" style="min-height: 75vh;">
            ...
            <iframe 
                src="assets/landing/dokumen/jurnal sadari.pdf" 
