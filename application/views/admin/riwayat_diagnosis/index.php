<div class="card">
    ...
    <div class="px-3 demo-inline-spacing d-flex gap-2">
        <button class="btn btn-primary btn-sm flex-grow-1 btn-section-block-overlay" type="button"
            id="searchDataButton">Cari<span class="spinner-border spinner-border-sm d-none ms-2" role="status"
